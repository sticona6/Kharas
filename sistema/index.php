...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>kharas Tienda Online</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Karas Tienda Online Productos">
    <meta name="author" content="Kharas">
	<!-- Less styles  
                ...
                <div class="container">
                  ...
                  <div class="nav-collapse">
                    <ul class="nav">
					  ...
					  <!---<li class=""><a href="#/">Servicios Paypal</a></li>--->
					</ul>
