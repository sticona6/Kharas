...
$qry_plg= mysqli_query($koneksidb, $sql_plg);
$hsl_plg=mysqli_fetch_array($qry_plg);
...
$cekQry = mysqli_query($koneksidb, $cekSql) or die("Gagal Keranjang".mysqli_error());
...
if(isset($_POST['btnSimpan'])){
    ...
    if (count($pesanError)>=1) {
       ...
       $tanggal         = date('Y-m-d');
        ...
        $myQry= mysqli_query($koneksidb, $mySql)or die("Gagal Query1".mysqli_error());
        if ($myQry) {
            ...
            while ($bacaData =mysqli_fetch_array($bacaQry)) {
                ...
                mysql_query($simpanSql, $koneksidb) or die ("Gagal Query 2 Simpan tuh".mysqli_error());
          
           $sqlStok="UPDATE barang SET stok=stok- $Jumlah WHERE kd_barang='$Kode'";
                mysqli_query($koneksidb, $sqlStok) or die("Gagal Query Stok".mysqli_error());
            }
            ...
            mysqli_query($koneksidb, $hapusSql) or die("Gagal Query hapus Keranjang".mysqli_error());
            ...
            <div class="span9">
                <table class="table table-striped" >
                    ...
                    <?php 
                        ...
                        $myQry = mysqli_query($koneksidb, $mySql)or die("Gagal SQL".mysqli_error());
                        $nomor=0;
                ...
                <td><div class="control-group">
                    ...
                    <td>
                        <select type="text" id="propinsi" name="prov" value="">
                            ...
                            $propinsi =mysqli_query($koneksidb, "SELECT * FROM prov ORDER BY nama_prov");
                            while ($dataProvinsi=mysqli_fetch_array($propinsi)) {
            ...
            <tr>
                ...
                <td><div class="controls">
                    <select type="text" id="kota" name="kota">
                        ...
                        $kota=@mysqli_query($koneksidb, "SELECT * FROM kabkot ORDER BY nama_kabkot");
                        while ($dataKota=mysqli_fetch_array($kota)) {
                ...
                <td>
                    <div class="controls">
                        <select type="text" id="kec" name="kec">
                            ...
                            $kec=mysqli_query($koneksidb, "SELECT * FROM kec ORDER BY nama_kec");
                            while ($dataKec=mysqli_fetch_array($kec)) {
