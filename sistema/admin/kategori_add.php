...
if(isset($_POST['btnSimpan'])){
	...
	$cekQry	=mysqli_query($cekSql, $koneksidb) or die ("Eror Query".mysqli_error());
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO kategori SET kd_kategori='$kodeBaru',
					nm_kategori='$txtNama'";
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <th colspan="3">AGREGAR CATEGORIA</th>
	</tr>
	<tr>
