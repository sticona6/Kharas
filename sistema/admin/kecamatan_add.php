...
if (isset($_POST['btnSimpan'])) {
    ...
    $cekQry = mysqli_query($koneksidb, $cekSql) or die("Error Query:".mysqli_error());
    ...
    if (count($pesanError)>=1) {
        ...
        $myQry= mysqli_query($koneksidb, $mySql)or die("Gagal Simpan".mysqli_error());
        if ($myQry) {
...
$dataKode= mysqli_num_rows($pageQry)+1;
