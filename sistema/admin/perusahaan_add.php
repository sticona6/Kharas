...
if (isset($_POST['btnSave'])) {
    ...
    $cekquery = mysqli_query($koneksidb, $cekSql) or die("error Query SEEETT" .mysqli_error());
    ...
    if (count($message)>=1)
        ...
        $actqry = mysqli_query($koneksidb, $savesql) or die ("Data tidak tersimpan :" .mysqli_error());            
        if($actqry)
          {
