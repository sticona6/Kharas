...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="550" border="0"  class="table-list">
    ...
    <tr>
      <td width="130"><strong>Periodo de Transaccion</strong></td>
...
Lista <strong>Transaccion de Reservaciones </strong> de <b><?php echo $tglAwal; ?></b> a <b><?php echo $tglAkhir; ?></b><br />
<br />
<table class="table-list" width="850" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="117" align="right" bgcolor="#CCCCCC"><strong>Cantidad Productos </strong></td>
    <td width="126" align="right" bgcolor="#CCCCCC"><strong>Total (S/.) </strong></td>
