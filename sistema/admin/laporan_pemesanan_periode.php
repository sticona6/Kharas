...
Transaccion Lista de Pedidos de <b><?php echo $tglAwal; ?></b> a <b><?php echo $tglAkhir; ?></b><br /><br />

<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    <th width="4%" align="center" bgcolor="#CCCCCC"><b>Nro</b></th>
    <th width="9%" bgcolor="#CCCCCC"><b>Fecha</b></th>
     <th width="15%" bgcolor="#CCCCCC"><b>Cod. Cliente </b></th>
   <th width="32%" bgcolor="#CCCCCC"><strong>Nombre Cliente </strong></th>
    <th width="20%" align="right" bgcolor="#CCCCCC">Total Productos </th>
    <th width="17%" align="right" bgcolor="#CCCCCC"><b>Total (S/.) </b></th>
    <th width="8%" align="right" bgcolor="#CCCCCC"><strong>Estado </strong></th>
  ...
  <tr>
    ...
    <td align="right">S/. <b><?php echo format_angka($unikTransfer); ?></b></td>
    <td align="right" bgcolor="#FFFFCC"><?php echo $myData['status_bayar']; ?></td>
    <td width="6%" align="center"><a href="pemesanan_lihat.php?Kode=<?php echo $Kode; ?>" target="_blank" class='button white small'>VER </a> </td>
  </tr>
  <?php } ?>
</table>
