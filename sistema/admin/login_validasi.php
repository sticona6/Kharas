...
if(isset($_POST['btnLogin'])){
	...
	$pesanError = array();
	if ( trim($txtUsername)=="") {
		$pesanError[] = "Datos <b> Username </b>  Incorrecto!";		
	}
	if (trim($txtPassword)=="") {
		$pesanError[] = "Datos <b> Password </b> Incorrecto!";		
	}
	...
	if (count($pesanError)>=1 ){
		...
		$loginQry = mysqli_query($koneksidb, $loginSql)  or die ("Query Periksa Password Salah : ".mysqli_error());
