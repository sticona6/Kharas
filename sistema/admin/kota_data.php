...
$pageSql = "SELECT id_prov, id_kabkot, nama_kabkot FROM kabkot";
...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-common">
  <tr>
    <td colspan="2" align="right"><h1><b>DATOS DE CIUDAD/PROVINCIA</b></h1></td>
  </tr>
  ...
  <tr>
    <td colspan="2" align="right"><a href="?open=Kota-Add" target="_self"><img src="../images/btn_add_data.png" height="30" border="0" /></a></td>
  </tr>
  <tr>
    <td colspan="2">
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="88" bgcolor="#CCCCCC"><strong>ID Departamento</strong></th>
        <th width="20" bgcolor="#CCCCCC"><strong>ID Ciudad</strong></th>
        <th width="180" bgcolor="#CCCCCC"><strong> Ciudad / Provincia</strong></th>
        <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>Herramientas</strong></td>
        </tr>
      <?php	
	$mySql = "SELECT id_prov,id_kabkot,nama_kabkot FROM kabkot ORDER BY id_kabkot ASC LIMIT $hal, $baris";
	$myQry = mysqli_query($koneksidb, $mySql)  or die ("Query salah : ".mysqli_error());
	$nomor = $hal; 
	while ($myData = mysqli_fetch_array($myQry)) {
		$nomor++;
		$Kode = $myData['id_kabkot'];
	?>
      <tr>
        ...
        <td width="44" align="center"><a href="?open=Barang-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Editar">Editar</a></td>
        <td width="42" align="center"><a href="?open=Barang-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Eliminar" onclick="return confirm('Seguro que va a ELIMNAR ESTA CIUDAD  ... ?')">Eliminar</a></td>
      </tr>
      <?php } ?>
    </table></td>
  </tr>
