...
$infoQry	=mysqli_query($koneksidb, $infoSql) or die("Query Salah".mysqli_error());
...
$barang2Sql =mysqli_query($koneksidb, "SELECT barang.*,  kategori.nm_kategori FROM barang 
...
$nomor = 0;
while ($barang2Data = mysqli_fetch_array($barang2Sql)) {
	$nomor++;
